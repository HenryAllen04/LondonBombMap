...
export default function Comparison(){
 ...
 return <main className="comparison">
  <header><div><a href="/">← Pimlico 3D</a><h1>The same place. Different buildings.</h1><p>Cambridge Street / Alderney Street · paper map registered to street junctions</p></div><a href="https://www.openstreetmap.org/#map=19/51.48854/-0.1411" target="_blank" rel="noreferrer">Open modern map ↗</a></header>
  <p><a href="/proto/london-island/compare/overlay">Align an area on the full paper sheet →</a> · <a href="/proto/london-island/compare/review">Detailed building-section review</a></p>
